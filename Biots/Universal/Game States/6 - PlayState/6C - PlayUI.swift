		...
		return VStack {
			...
			HStack {
				...
				Button("Save", action: {
					...
					let gameState = GameState(gameMode: .normal, algaeTarget: algaeTarget, worldSize: Constants.Env.worldSize, worldObjects: worldScene.currentWorldObjects, genomes: worldScene.currentGenomes)
